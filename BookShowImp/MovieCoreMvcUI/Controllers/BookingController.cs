...
namespace MovieCoreMvcUI.Controllers
{
    public class BookingController : Controller
    {
        ...
        public async Task<IActionResult> DeleteBooking(int bookingId)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                string endPoint = _configuration["WebApiBaseUrl"] + "Booking/GetBookingById?userId=" + bookingId;
                using (var response = await client.GetAsync(endPoint))
                {
                    if (response.StatusCode == System.Net.HttpStatusCode.OK)
                    {
        ...
        public async Task<IActionResult> DeleteBooking(Booking booking)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                string endPoint = _configuration["WebApiBaseUrl"] + "Booking/DeleteBooking?bookingId=" + booking.BookingId;
